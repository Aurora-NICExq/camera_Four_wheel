...
{
    { PIN_KEY_UP,    MENU_KEY_UP,    1, 0, 0, 0 },   /* KEY1 P20_6 */
    { PIN_KEY_DOWN,  MENU_KEY_DOWN,  1, 0, 0, 0 },   /* KEY2 P20_7 */
    { PIN_KEY_ENTER, MENU_KEY_ENTER, 0, 0, 0, 0 },   /* KEY3 P11_2 */
    { PIN_KEY_BACK,  MENU_KEY_BACK,  0, 0, 0, 0 },   /* KEY4 P11_3 */
};
