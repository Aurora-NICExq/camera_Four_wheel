...
/*-------------------------------------------------------------------------------------------------------------------
 * motor_hw_init — 舵机/电机 PWM、蜂鸣器、按键、系统定时器初始化
 * 上电立即输出：舵机中位 + 电机占空比 0（任何时刻都不允许出现"上电瞬间乱转"）。
 *------------------------------------------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------------------------------------------------
 * motor_apply — 每帧写入硬件。舵机命令无条件再过一次机械限位钳制（双保险）。
 *------------------------------------------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------------------------------------------------
 * motor_stop — 占空比立即置 0。本硬件唯一的"停"：之后车靠滑行减速直到静止。
 *------------------------------------------------------------------------------------------------------------------*/
